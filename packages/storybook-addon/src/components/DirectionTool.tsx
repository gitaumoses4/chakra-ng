...
export const DirectionTool = () => {
  ...
  const [direction, setDirection] = useAddonState(DIRECTION_TOOL_ID, globals[DIRECTION_TOOL_ID] || "ltr");
  ...
  return (
    <IconButton active={direction === "rtl"} title={`Set layout direction to ${targetDirection}`} onClick={toggleDirection} content="" rel="" rev="">
