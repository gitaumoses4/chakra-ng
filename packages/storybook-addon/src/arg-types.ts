...
function validateColorScheme(value: object) {
  ...
  return ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900"].every((term) => valueKeys.includes(term));
}
...
>(theme: Theme, componentName: ComponentName) {
  ...
  const argTypes: ArgTypes<Partial<Pick<ThemingProps<ComponentName>, ThemingArgTypeKey>>> = {};
