                ...
                code: [
                  {
                    ...
                    language: "html",
                    content:
                      '<div hStack [spacing]="4">\n  <chakra-button [leftIcon]="\'inbox\'" [colorScheme]="\'teal\'" [variant]="\'solid\'">Email</chakra-button>\n  <button chakraButton [rightIcon]="\'arrowRight\'" [colorScheme]="\'teal\'" [variant]="\'outline\'">Call us</button>\n</div>\n',
                  },
                  {
                    ...
                    code: [
                      {
                        ...
                        language: "html",
                        content:
                          '<chakra-button [isLoading]="true" [spinner]="spinner" [colorScheme]="\'blue\'">Click me</chakra-button>\n\n<ng-template #spinner>\n  <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n    <path fill="currentColor" d="M12,1A11,11,0,1,0,23,12,11,11,0,0,0,12,1Zm0,19a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" opacity=".25" />\n    <path\n      fill="currentColor"\n      d="M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z"\n      class="spinner_z9k8"\n    />\n  </svg>\n</ng-template>\n',
                      },
                      {
            ...
            code: [
              {
                ...
                language: "html",
                content:
                  '<div grid [templateColumns]="\'repeat(5, 1fr)\'" [gap]="6">\n  <div gridItem [width]="\'100%\'" [h]="10" [bg]="\'blue.500\'"></div>\n  <div gridItem [width]="\'100%\'" [h]="10" [bg]="\'blue.500\'"></div>\n  <div gridItem [width]="\'100%\'" [h]="10" [bg]="\'blue.500\'"></div>\n  <div gridItem [width]="\'100%\'" [h]="10" [bg]="\'blue.500\'"></div>\n  <div gridItem [width]="\'100%\'" [h]="10" [bg]="\'blue.500\'"></div>\n</div>\n',
              },
              {
                ...
                code: [
                  {
                    ...
                    language: "html",
                    content:
                      '<div simpleGrid [columns]="[2, null , 3]" [spacing]="\'40px\'">\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n</div>\n',
                  },
                  {
                ...
                code: [
                  {
                    ...
                    language: "html",
                    content:
                      "<div simpleGrid [minChildWidth]=\"'120px'\" [spacing]=\"'40px'\">\n  <div chakra [bg]=\"'tomato'\" [height]=\"'80px'\"></div>\n  <div chakra [bg]=\"'tomato'\" [height]=\"'80px'\"></div>\n  <div chakra [bg]=\"'tomato'\" [height]=\"'80px'\"></div>\n  <div chakra [bg]=\"'tomato'\" [height]=\"'80px'\"></div>\n  <div chakra [bg]=\"'tomato'\" [height]=\"'80px'\"></div>\n  <div chakra [bg]=\"'tomato'\" [height]=\"'80px'\"></div>\n</div>\n",
                  },
                  {
                ...
                code: [
                  {
                    ...
                    language: "html",
                    content:
                      '<div simpleGrid [columns]="2" [spacingX]="\'40px\'" [spacingY]="\'20px\'">\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n  <div chakra [bg]="\'tomato\'" [height]="\'80px\'"></div>\n</div>\n',
                  },
                  {
                ...
                code: [
                  {
                    ...
                    language: "html",
                    content:
                      "<div wrap [spacing]=\"'30px'\" [justify]=\"'center'\">\n  <div center [w]=\"'180px'\" [h]=\"'80px'\" [bg]=\"'red.200'\">Box 1</div>\n  <div center [w]=\"'180px'\" [h]=\"'80px'\" [bg]=\"'green.200'\">Box 2</div>\n  <div center [w]=\"'120px'\" [h]=\"'80px'\" [bg]=\"'tomato'\">Box 3</div>\n  <div center [w]=\"'180px'\" [h]=\"'80px'\" [bg]=\"'blue.200'\">Box 4</div>\n  <div center [w]=\"'180px'\" [h]=\"'80px'\" [bg]=\"'blackAlpha.500'\">Box 5</div>\n</div>\n",
                  },
                  {
