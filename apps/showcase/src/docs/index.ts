          ...
          code: [
            {
              ...
              language: "html",
              content:
                "<div chakraFlex [chakraStyles]=\"{ color: 'white' }\">\n  <div chakraCenter [chakraStyles]=\"{ w: '100px', bg: 'green.500' }\">\n    <span>Box 1</span>\n  </div>\n  <div chakraSquare [size]=\"'150px'\" [chakraStyles]=\"{ bg: 'blue.500' }\">\n    <span>Box 2</span>\n  </div>\n  <div [chakraStyles]=\"{ flex: 1, bg: 'tomato' }\">\n    <span>Box 3</span>\n  </div>\n</div>\n",
            },
            {
              ...
              code: [
                {
                  ...
                  language: "html",
                  content:
                    '<div chakraFlex [chakraStyles]="{ minWidth: \'max-content\', alignItems: \'center\'}" [gap]="2">\n  <div [chakraStyles]="{ p: 2 }">\n    <h2 chakraHeading [size]="\'md\'">ChakraNg App</h2>\n  </div>\n  <div chakraSpacer></div>\n  <div chakraFlex [gap]="2">\n    <chakra-button [colorScheme]="\'teal\'">Sign Up</chakra-button>\n    <chakra-button [colorScheme]="\'teal\'">Log In</chakra-button>\n  </div>\n</div>\n',
                },
                {
          ...
          code: [
            {
              ...
              language: "html",
              content:
                "<div chakraHStack [spacing]=\"'24px'\">\n  <div chakraSquare [chakraStyles]=\"{ bg: 'yellow.200', color: 'black'}\" [size]=\"'40px'\">1</div>\n  <div chakraSquare [chakraStyles]=\"{ bg: 'tomato'}\" [size]=\"'40px'\">2</div>\n  <div chakraSquare [chakraStyles]=\"{ bg: 'pink.100', color: 'black'}\" [size]=\"'40px'\">3</div>\n</div>\n",
            },
            {
          ...
          code: [
            {
              ...
              language: "html",
              content:
                "<div chakraStack [direction]=\"['column', 'row']\" [spacing]=\"'24px'\">\n  <div chakraSquare [chakraStyles]=\"{ bg: 'yellow.200', color: 'black'}\" [size]=\"'40px'\">1</div>\n  <div chakraSquare [chakraStyles]=\"{ bg: 'tomato'}\" [size]=\"'40px'\">2</div>\n  <div chakraSquare [chakraStyles]=\"{ bg: 'pink.100', color: 'black'}\" [size]=\"'40px'\">3</div>\n</div>\n",
            },
            {
